...
function Query($database, $un, $name){
	/*
	 *  Generates the SELECT query for the items in the user's inventory. The following line is the base query followed by 1 if statement
	 *  that add to the query if the name condition was sent.  If not sent, the query will return the same result as the my_inv
